 ...
 * @author gunav
 */
public class ManagePharmaEmployee extends javax.swing.JPanel {
    ...
    public ManagePharmaEmployee(JPanel workArea, OrganizationDirectory organizationDirectory) {
        initComponents(); 
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(215, 193, 615, 160));
        ...
        add(organizationJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(442, 156, 250, -1));

        jLabel2.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Organization: ");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(341, 162, -1, -1));
        ...
        add(backBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(33, 157, 80, 29));

        add(selectOrganizationJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(487, 380, 250, -1));

        jLabel3.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Organization : ");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(383, 386, -1, -1));

        jLabel4.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Employee Name :");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(367, 436, -1, -1));
        ...
        add(nameTxtField, new org.netbeans.lib.awtextra.AbsoluteConstraints(487, 430, 250, 24));
        ...
        add(addBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(508, 485, 110, 30));
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(356, 64, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/images/Untitled design (3).jpg"))); // NOI18N
        jLabel1.setText("jLabel1");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1190, 820));
