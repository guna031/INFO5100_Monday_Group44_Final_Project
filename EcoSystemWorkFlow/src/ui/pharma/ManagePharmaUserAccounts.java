 ...
 * @author gunav
 */
public class ManagePharmaUserAccounts extends javax.swing.JPanel {
    ...
    public ManagePharmaUserAccounts(JPanel workArea, Enterprise enterprise) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 116, 482, 170));
        ...
        add(organizationJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(467, 304, 209, -1));

        jLabel2.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        jLabel2.setText("Organization : ");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(332, 309, 100, 20));

        jLabel3.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        jLabel3.setText("Employee  Name :");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(311, 352, 121, 20));

        employeeJComboBox.setForeground(new java.awt.Color(255, 255, 255));
        add(employeeJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(467, 347, 209, -1));

        EmployeeRoleJComboBox.setForeground(new java.awt.Color(255, 255, 255));
        add(EmployeeRoleJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(467, 390, 209, -1));

        jLabel4.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        jLabel4.setText("Employee Role :");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(323, 395, 109, 20));

        jLabel5.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        jLabel5.setText("Username :");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(342, 433, 90, 30));

        usernameTxtField.setForeground(new java.awt.Color(255, 255, 255));
        add(usernameTxtField, new org.netbeans.lib.awtextra.AbsoluteConstraints(467, 434, 208, -1));

        passwordTxtField.setForeground(new java.awt.Color(255, 255, 255));
        add(passwordTxtField, new org.netbeans.lib.awtextra.AbsoluteConstraints(467, 476, 207, -1));

        jLabel6.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        jLabel6.setText("Password :");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(364, 480, 68, 20));
        ...
        add(addBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(424, 518, 90, -1));

        jLabel7.setFont(new java.awt.Font("Calibri", 1, 36)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Pharmaceutical");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 10, -1, -1));

        jLabel8.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("User Account");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 60, -1, -1));
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 950, 640));
    ...
    private void populateRoleComboBox(Enterprise e) {
        ...
        if (organization instanceof DrugProductionOrganization) {
            EmployeeRoleJComboBox.addItem(new ProductionManagerRole());
        } 
        else if (organization instanceof QualityControlAndAssuranceOrganization) {
            EmployeeRoleJComboBox.addItem(new QualityAnalystRole());
        } 
